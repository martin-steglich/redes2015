...
public:
    Comando(char* sourceHost, char* sourcePort, char* destHost, char* destPort, char* numSeq,tipoComando tipo,char* usuario,char* mensaje,bool mensajePrivado,char*  destinatarioMensajePrivado);
    tipoComando getTipo();
    char* getusuario();
    char* getMensaje();
